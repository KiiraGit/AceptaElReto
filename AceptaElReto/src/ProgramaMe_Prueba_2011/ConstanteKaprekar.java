...
{	//	Tiempo: 1.943s		Memoria: 3585KiB
	...
	{
		char[] asc = new char[4];
//		StringBuilder ascendent = new StringBuilder();
//		StringBuilder descendent = new StringBuilder();
...
//		{
//			ascendent.append(ch);
//			descendent.insert(0, ch);
//		}
//		trans[0] = Integer.parseInt(String.valueOf(descendent));
//		trans[1] = Integer.parseInt(String.valueOf(ascendent));
